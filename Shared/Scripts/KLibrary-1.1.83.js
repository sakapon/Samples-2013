...
(function (KLibrary) {
    ...
    function format(_format, args) {
        ...
        return _format.replace(/\{([0-9]+)(:[^\}]*)?\}/g,
            function (m, g1, g2) {
                var v = args instanceof Array ? args[parseInt(g1)] : a[parseInt(g1) + 1];
                if (v == null) return "";
                return v instanceof Date ? v.format(isNullOrEmpty(g2) ? null : g2.substring(1)) : v.toString();
            });
    }
    ...
    function formatObject(template, obj, encodeHtml) {
        ...
        return template.replace(/\$\{([a-zA-Z0-9_\.\[\]]*)(>[^:\}]*)?(:[^\}]*)?\}/g,
            function (m, g1, g2, g3) {
                ...
                if (v == null) return "";
                var s = v instanceof Date ? v.format(isNullOrEmpty(g3) ? null : g3.substring(1)) : v.toString();
